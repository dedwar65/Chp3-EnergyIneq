...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw96/intrvw96"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_1996_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_1996_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (1996) (`q') (g_fincbtax) (g_fsalaryx)
}

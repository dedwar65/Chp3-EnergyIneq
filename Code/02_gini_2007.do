...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw07/intrvw07"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2007_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2007_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2007) (`q') (g_fincbtax) (g_fsalaryx)
}

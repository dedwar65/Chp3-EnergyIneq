...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw97/intrvw97/intrvw97"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_1997_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_1997_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (1997) (`q') (g_fincbtax) (g_fsalaryx)
}

...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw01/intrvw01"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2001_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2001_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2001) (`q') (g_fincbtax) (g_fsalaryx)
}

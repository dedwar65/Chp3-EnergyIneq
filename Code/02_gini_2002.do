...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw02/intrvw02"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2002_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2002_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2002) (`q') (g_fincbtax) (g_fsalaryx)
}

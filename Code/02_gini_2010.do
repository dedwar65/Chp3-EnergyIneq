...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw10/intrvw10"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2010_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2010_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2010) (`q') (g_fincbtax) (g_fsalaryx)
}

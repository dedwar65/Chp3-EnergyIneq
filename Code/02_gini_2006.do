...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw06/intrvw06"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2006_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2006_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2006) (`q') (g_fincbtax) (g_fsalaryx)
}

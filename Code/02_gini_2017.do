...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw17/intrvw17"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2017_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2017_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2017) (`q') (g_fincbtax) (g_fsalaryx)
}

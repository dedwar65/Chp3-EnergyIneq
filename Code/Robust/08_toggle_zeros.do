...
*
* Output:
*   - $robust_data/gini_rr_merged_zeros.dta
*
* Methodology:
*   - Exclude zero/negative consumption/income before Gini computation
...
display _n "========================================"
display "TOGGLE: Zero Exclusion"
display "========================================" _n

****************************************************
* 1. Compute Ginis excluding zeros
****************************************************
display _n "=== Computing Ginis Excluding Zeros (1990-2008) ==="
        ...
        quietly {
            ...
            * Load income data
            ...
            if !_rc {
                ...
                * Exclude zeros/negatives and compute income Ginis
                preserve
...
****************************************************
sort year quarter
save "$robust_data/gini_rr_merged_zeros.dta", replace

display _n "========================================"
display "TOGGLE COMPLETE: Zero Exclusion"
display "========================================"
display "Saved: $robust_data/gini_rr_merged_zeros.dta"
...
use "$robust_data/gini_rr_merged_zeros.dta", clear

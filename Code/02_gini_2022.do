...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw22"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2022_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2022) (`q') (g_fincbtax) (g_fsalaryx)
}

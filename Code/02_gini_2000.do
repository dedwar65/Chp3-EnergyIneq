...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw00/intrvw00"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2000_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2000_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2000) (`q') (g_fincbtax) (g_fsalaryx)
}

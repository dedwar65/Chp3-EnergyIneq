...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw98/intrvw98/intrvw98"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_1998_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_1998_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (1998) (`q') (g_fincbtax) (g_fsalaryx)
}

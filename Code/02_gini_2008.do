...
global intr  "/Volumes/SSD PRO/Github-forks/Chp3-EnergyIneq/Code/Data/CEX/intrvw08/intrvw08"
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/cons_2008_cuq.dta", clear
        keep if quarter == `q'
...
forvalues q = 1/4 {
    quietly {
        use "$deriv/income_2008_cuq.dta", clear
        keep if quarter == `q'
    ...
    post gini_inc_post (2008) (`q') (g_fincbtax) (g_fsalaryx)
}
